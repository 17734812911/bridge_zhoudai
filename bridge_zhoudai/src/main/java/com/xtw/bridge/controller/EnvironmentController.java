...
public class EnvironmentController {
    ...
    public ResponseFormat queryEnvironmentDatasPage(String terminalId, Integer pageNum, Integer pageSize, String begintime, String endtime) throws ParseException  {
